...
class Transformer(t2t_model.T2TModel):
    ...
    def decode(self,
        ...
        Args:
          ...
          decoder_self_attention_bias: Bias and mask weights for decoder
              self-attention. [batch_size, decoder_length] 下三角
          hparams: hyperparameters for model.
    ...
    def body(self, features):
        ...
        decoder_output = self.decode(
            decoder_input,
            encoder_output,  # 接用 encoder 的输出 理解
            encoder_decoder_attention_bias,  # 这个估计就是 encoder decoder 的编码 目前不理解
            decoder_self_attention_bias,  # 这个应该是 decoder 的 bias, 也就是 下三角矩阵
            hparams,
